...
class NLSPNSummarynew(BaseSummary):
    ...
    def save(self, epoch, idx, sample, output):
        with torch.no_grad():
            ...
            #path_save_rgb = '{}/05_rgb.png'.format(self.path_output)
            path_save_dep = '{}/05_dep.png'.format(self.path_output)
            path_save_pred = '{}/06_pred_final.png'.format(self.path_output)
            path_save_pred_gray = '{}/07_pred_final_gray.png'.format(
                self.path_output)
            path_save_gt = '{}/08_gt.png'.format(self.path_output)
            ...
            imageio.imwrite(path_save_dep, dep)
